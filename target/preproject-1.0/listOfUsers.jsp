...
<table border="2">
    ...
    <c:forEach items="${users}" var = "user">
        <tr>
            ...
            <td>${user.getRole()}</td>
            <td>
                <a href="${pageContext.request.contextPath}/admin/edit?id=${user.getId()}" methods="get">
                    <input type="submit" name="update" value="Edit" style="float:left">
                </a>
                <a href="${pageContext.request.contextPath}/admin/delete?id=${user.getId()}" methods="get">
